...
export const JAIRUVIEL_STARDUST: NPCCombatProfile = {
...
export const BRUTUS: NPCCombatProfile = {
  id: 'brutus',
  name: 'Brutus',
  emoji: '🐲',
  tier: 'elite',
...
export const KING_JOSEPH: NPCCombatProfile = {
  id: 'king_joseph',
...
export const KING_SURTUPIO: NPCCombatProfile = {
  id: 'king_surtupio',
  name: 'King Surtupio',
  emoji: '🦁',
  tier: 'elite',
...
export const BUCKWILD: NPCCombatProfile = {
  id: 'buckwild',
...
export const PHOEBE: NPCCombatProfile = {
  id: 'phoebe',
...
export const KOA: NPCCombatProfile = {
  id: 'koa',
  name: 'Ko\'a',
  emoji: '🪸',
  tier: 'standard',
...
export const LUMINARAFAE: NPCCombatProfile = {
  id: 'luminarafae',
  name: 'LuminaraFae',
  emoji: '💎',
  tier: 'elite',
...
export const ARIS: NPCCombatProfile = {
  id: 'aris',
...
export const MOGWAI_CHORUS: NPCCombatProfile = {
  id: 'mogwai_chorus',
...
// ── HERO LOOKUP TABLE ──
export const HERO_PROFILES: Record<string, NPCCombatProfile> = {
...
export function getHeroProfile(idOrName: string): NPCCombatProfile | undefined {
...
export function getAllProfiles(): Record<string, NPCCombatProfile> {
